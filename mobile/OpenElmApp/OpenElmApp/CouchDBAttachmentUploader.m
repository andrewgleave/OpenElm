...
- (void)upload:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options 
{
    ...
    NSURL *tmpURL = [NSURL URLWithString:couchURI];
    NSString *partsPath = [NSString pathWithComponents: [NSArray arrayWithObjects:docID, attachmentName, nil]];
    tmpURL = [tmpURL URLByAppendingPathComponent:partsPath];
    
    NSURL *url = [NSURL URLWithString:[[NSString stringWithFormat:@"%@?rev=%@", [tmpURL absoluteString], docRevision] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
